...
class SunPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      final left  = Offset(cx + math.cos(angle - halfW) * r * 0.55, cy + math.sin(angle - halfW) * r * 0.55);
      final right = Offset(cx + math.cos(angle + halfW) * r * 0.55, cy + math.sin(angle + halfW) * r * 0.55);
