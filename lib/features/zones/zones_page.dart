...
class ZonesPage extends StatefulWidget {
  ...
  @override State<ZonesPage> createState() => _ZonesPageState();
}
  ...
  void _showAddDialog() {
    ...
    showDialog(context: context, builder: (ctx) => StatefulBuilder(builder: (ctx, sd) => AlertDialog(
      ...
      content: Column(mainAxisSize: MainAxisSize.min, children: [
        buildDialogField(nameCtrl, 'Zone Name (e.g. Zone F – Airport)'),
        ...
        Wrap(spacing: 8, runSpacing: 8, children: _colorOptions.entries.map((e) {
          ...
          final sel   = selectedHex == e.value;
          return GestureDetector(onTap: () => sd(() => selectedHex = e.value),
            child: Container(width: 32, height: 32, decoration: BoxDecoration(color: color, shape: BoxShape.circle,
              border: sel ? Border.all(color: AppColors.textDark, width: 2.5) : null)));
        }).toList()),
      ]),
      actions: [
      ...
      builder: (_) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            Expanded(child: Text(item.name, style: const TextStyle(color: AppColors.textDark, fontSize: 20, fontWeight: FontWeight.w800))),
          ]),
        ...
        : Padding(padding: const EdgeInsets.all(16), child: Column(children: [
            Container(width: double.infinity, padding: const EdgeInsets.all(20),
              ...
              child: Stack(children: [
                Positioned(right: -10, bottom: -20, child: Opacity(opacity: 0.15,
                    child: SizedBox(width: 120, height: 120, child: const CustomPaint(painter: SunPainter())))),
            ...
            Expanded(child: RefreshIndicator(color: AppColors.blue, onRefresh: _load,
              child: ListView.separated(itemCount: _zones.length,
