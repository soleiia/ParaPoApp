...
class _TerminalsPageState extends State<TerminalsPage> {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, sd) => AlertDialog(
          ...
          title: const Text('Add Terminal', style: TextStyle(
              fontWeight: FontWeight.w800, color: AppColors.textDark)),
          content: SingleChildScrollView(child: Column(
              mainAxisSize: MainAxisSize.min, children: [
            buildDialogField(catCtrl, 'Category (e.g. TRICYCLE TERMINAL)'),
            ...
            Row(children: [
              ...
              GestureDetector(
                onTap: () => _pickEmoji(ctx, (e) => sd(() => emoji = e)),
                child: Container(
              ...
              onPressed: () async {
                ...
                if (name.isNotEmpty) {
                  await _repo.add(TerminalModel(
                    category:    catCtrl.text.trim().toUpperCase(),
                    name:        name,
        ...
        child: Column(mainAxisSize: MainAxisSize.min,
          ...
          Row(children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
              Text(item.category, style: const TextStyle(color: AppColors.blue,
          ...
          BlueBtn(label: 'Get Directions', onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('Showing ${item.name} on map'),
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, sd) => AlertDialog(
          backgroundColor: Colors.white,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
          title: const Text('Edit Terminal', style: TextStyle(
              fontWeight: FontWeight.w800, color: AppColors.textDark)),
          content: SingleChildScrollView(child: Column(
              mainAxisSize: MainAxisSize.min, children: [
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                await _repo.update(TerminalModel(
                  id:          item.id,
                  category:    catCtrl.text.trim().toUpperCase(),
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      PageHeader(title: 'Terminals', onAdd: _showAddDialog,
          onSearch: _onSearch),
      Expanded(
        child: _loading
            ? const LoadingState()
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Padding(
                            ...
                            child: Text(t.description, style: const TextStyle(
