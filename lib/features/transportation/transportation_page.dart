      ...
      builder: (ctx) => StatefulBuilder(
          builder: (ctx, sd) => AlertDialog(
                ...
                content: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  buildDialogField(fareCtrl, 'Fare (₱)',
              ...
              Row(children: [
                ...
                IconButton(
                    ...
                    onPressed: () async {
                      Navigator.pop(context);
                      final confirm =
                          await showDeleteDialog(context, item.name);
                      if (confirm == true) {
...
class _TransportTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
        ...
        subtitle: Padding(
            ...
            child: Text('₱${item.fare.toStringAsFixed(2)}',
                style:
